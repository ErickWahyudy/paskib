...
class login_m extends CI_model
{
 ...
 public function peserta($nama='', $asal_sekollah='', $level='peserta')
 {
  return $this->db->query("SELECT * from tb_peserta where nama_peserta='$nama' AND asal_sekollah='$asal_sekollah' AND level='$level' limit 1");
 }

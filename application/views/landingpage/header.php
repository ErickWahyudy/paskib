...
<body>
    ...
    <!-- <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <i class="fa fa-wifi fa-2x text-danger position-absolute top-50 start-50 translate-middle"></i>
    </div> -->
    <!-- Spinner End -->
        ...
        <div class="row gx-0 align-items-center d-none d-lg-flex">
            ...
            <div class="col-lg-6 px-5 text-end">
                ...
                <div class="h-100 d-inline-flex align-items-center">
                    <a class="btn-square text-danger border-end rounded-0" href=""><i class="fab fa-facebook-f"></i></a>
                    <a class="btn-square text-danger border-end rounded-0" href=""><i class="fab fa-twitter"></i></a>
                    <a class="btn-square text-danger border-end rounded-0" href=""><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn-square text-danger pe-0" href=""><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div> -->
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg bg-danger navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav me-auto p-3 p-lg-0">
                <a href="login" class="nav-item nav-link <?php if($this->uri->segment(1)=="login"){echo "active";}?>">Home</a>
                <a href="peserta/cari" class="nav-item nav-link <?php if($this->uri->segment(1)=="peserta"){echo "active";}?>">Lihat Hasil Nilai</a>
            </div>
            <!-- <a href="login" target="" class="btn btn-sm btn-light rounded-pill py-2 px-4">Daftar sekarang ?</a> -->
        </div>
    </nav>
    <!-- Navbar End -->
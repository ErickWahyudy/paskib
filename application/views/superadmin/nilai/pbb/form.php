...
$(document).ready(function() {
    $('#add').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('superadmin/nilai/pbb/api_add') ?>",
            type: "POST",
...
$(document).on('submit', '#edit', function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('superadmin/nilai/pbb/api_edit/') ?>" + form_data.get('id_pbb'),
        dataType: "json",
        data: form_data,
        processData: false,
        contentType: false,
...
function hapusnilai(id_pbb) {
    swal({
        ...
        if (result.value) { // Only delete the data if the user clicked on the confirm button
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('superadmin/nilai/pbb/api_hapus/') ?>" + id_pbb,
                dataType: "json",
            }).done(function() {
                swal({
                    title: "Berhasil",

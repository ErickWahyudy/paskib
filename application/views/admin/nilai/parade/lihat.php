    ...
    <table id="" class="table table-bordered  table-striped">
        ...
        <tbody>
            ...
            <tr>
                 ...
                 <?php $matriks = $this->db->get_where('tb_matriks', ['id_kriteria' => 'K005ndLkXQ'])->row_array(); ?>
...
$(document).ready(function() {
    $('#add').submit(function(e) {
        e.preventDefault();
        $.ajax({
            url: "<?= site_url('admin/nilai/matriks/api_add_parade') ?>",
            type: "POST",
...
function hapusnilai() {
    swal({
        ...
        if (result.value) { // Only delete the data if the user clicked on the confirm button
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('admin/nilai/parade/api_empty_table/') ?>",
                dataType: "json",
            }).done(function() {
                swal({
                    title: "Berhasil",
